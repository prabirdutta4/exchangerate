                       ...
                       <div class="form-group">
					     <div class="col-xs-9">
                            <div class="input-group col-xs-3">
								...
								<select ng-model="country"  class="form-control" id="from_country" name="from_country" required ng-init="country = '{{ old('country') }}'">
							...
							<div class="input-group col-xs-3">
						        ...
						        <select ng-model="country"  class="form-control" id="to_country" name="to_country" required ng-init="country = '{{ old('country') }}'">
									<option value="">{{ trans('app.select_country')}} </option>	
									@foreach($country as $data)
										<option value="{{$data->code}}">{{$data->country}}</option>
									@endforeach
