...
<!-------------- roles and permission  menu --------------->
	...
	<!-------------- Message  menu --------------->
		@permission('exchangerate.search')
			 <li class="site-menu-item has-sub {{ Request::is('exchangerate') ? 'active open' : '' }}">
              <a href="javascript:void(0)">
			  <i class="site-menu-icon fa fa-book-o" aria-hidden="true"></i>
                <span class="site-menu-title">{{ trans('app.exchangerate')}}</span>
                <span class="site-menu-arrow"></span>
              </a>
              <ul class="site-menu-sub">
                <li class="site-menu-item {{ Request::is('exchangerate') ? 'active' : '' }}">
                  <a class="animsition-link" href="{{URL::to('/exchange_rate')}}">
                    <span class="site-menu-title">{{ trans('app.exchangerate')}}</span>
                  </a>
                </li>
              </ul>
