...
<!-------------- Message  menu --------------->
		...
		<?php endif; // Entrust::can ?>		
    <!-------------- Message  menu --------------->
		<?php if (\Entrust::can('attendance.add')) : ?>
			 <li class="site-menu-item has-sub <?php echo e(Request::is('attendance') ? 'active open' : ''); ?>">
              <a href="javascript:void(0)">
			  <i class="site-menu-icon fa fa-book-o" aria-hidden="true"></i>
                <span class="site-menu-title"><?php echo e(trans('app.attendance')); ?></span>
                <span class="site-menu-arrow"></span>
              </a>
              <ul class="site-menu-sub">
                <li class="site-menu-item <?php echo e(Request::is('attendance') ? 'active' : ''); ?>">
                  <a class="animsition-link" href="<?php echo e(URL::to('/attendance')); ?>">
                    <span class="site-menu-title"><?php echo e(trans('app.attendance')); ?></span>
                  </a>
                </li>
              </ul>
