...
<ul class="nav nav-tabs nav-tabs-line" data-plugin="nav-tabs" role="tablist">
    ...
    <li><a data-toggle="tab" title="DocImage" class="overview" href="#docimage"><span class="glyphicon glyphicon-picture"></span> <?php echo e(trans('app.change_doc_picture')); ?></a></li>
</ul>	
</div>
...
<div id="docimage" class="tab-pane fade">
    <div class="col-lg-6">
     <form class="form-horizontal" role="form" id="upload_form" method="POST" enctype="multipart/form-data">
                   <?php echo e(csrf_field()); ?>				   
			    <input type="hidden" name="imageusername" value="<?php echo e($userdata->username); ?>" class="form-control">
			  ...
			  <?php echo e(trans('app.update_picture')); ?>
	...
	<div class="col-lg-6">
	    <div id="uploaded_image">
	                <?php if(!empty($userdata->document_img)): ?>
					<img src="<?php echo e($userdata->document_img); ?>" style="background:#a8aeb1; border-radius:7px; width:300px;padding:30px;height:300px;">						
					<?php else: ?>
						<?php if($userdata->gender == 'Female'): ?>
							<img src="<?php echo e(URL::to('images/female.png')); ?>" style="background:#a8aeb1; border-radius:7px; width:300px;padding:30px;height:300px;">							
						<?php else: ?>
							<img src="<?php echo e(URL::to('images/default.png')); ?>" style="background:#a8aeb1; border-radius:7px; width:300px;padding:30px;height:300px;">						  
						<?php endif; ?>							
					<?php endif; ?>	
        </div>					
	</div>
...
$('.upload-result').on('click', function (ev) {
 ...
 $('#upload_form').on('submit', function(event){
  ...
  $.ajax({
   url:"<?php echo e(URL::to('uploadDocument')); ?>/<?php echo e($userdata->id); ?>",
   method:"POST",
