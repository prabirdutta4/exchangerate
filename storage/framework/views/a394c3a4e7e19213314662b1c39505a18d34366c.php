          ...
          <div class="row row-lg">
            <div class="col-lg-6 col-md-12">
              <div class="example example-well height-350">
                <img class="center" src="<?php echo e(URL::to('/')); ?>/assets/examples/images/modal/sweet-alert.png" alt="...">
              </div>
            </div>
            <div class="col-lg-6 col-md-12">
              <!-- Example Styles -->
...
<?php $__env->stopSection(); ?>
 <script src="<?php echo e(URL::to('/')); ?>/global/vendor/bootstrap-sweetalert/sweet-alert.js"></script>
