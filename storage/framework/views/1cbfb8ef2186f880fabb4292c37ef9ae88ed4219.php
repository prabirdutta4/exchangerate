                  ...
                  <ul class="list-group">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a class="avatar" href="javascript:void(0)">
                            <img class="img-responsive" src="<?php echo e(URL::to('/')); ?>/global/portraits/2.jpg" alt="...">
                          </a>
                        </div>
                    ...
                    <li class="list-group-item">
                      <div class="media">
                        <div class="media-left">
                          <a class="avatar" href="javascript:void(0)">
                            <img class="img-responsive" src="<?php echo e(URL::to('/')); ?>/global/portraits/3.jpg" alt="...">
                          </a>
                        </div>
                        <div class="media-body">
                          ...
                          <div class="profile-brief">
                            <img class="profile-uploaded" src="<?php echo e(URL::to('/')); ?>/global/photos/placeholder.png" alt="...">
                            <img class="profile-uploaded" src="<?php echo e(URL::to('/')); ?>/global/photos/placeholder.png" alt="...">
                            <img class="profile-uploaded" src="<?php echo e(URL::to('/')); ?>/global/photos/placeholder.png" alt="...">
                            <img class="profile-uploaded" src="<?php echo e(URL::to('/')); ?>/global/photos/placeholder.png" alt="...">
                          </div>
                    ...
                    <li class="list-group-item">
                      <div class="media">
                        <div class="media-left">
                          <a class="avatar" href="javascript:void(0)">
                            <img class="img-responsive" src="<?php echo e(URL::to('/')); ?>/global/portraits/4.jpg" alt="...">
                          </a>
                        </div>
                        <div class="media-body">
                    ...
                    <li class="list-group-item">
                      <div class="media media-lg">
                        <div class="media-left">
                          <a class="avatar" href="javascript:void(0)">
                            <img class="img-responsive" src="<?php echo e(URL::to('/')); ?>/global/portraits/5.jpg" alt="...">
                          </a>
                        </div>
                        <div class="media-body">
                          ...
                          <div class="profile-brief">
                            <div class="media">
                              <a class="media-left">
                                <img class="media-object" src="<?php echo e(URL::to('/')); ?>/global/photos/placeholder.png" alt="...">
                              </a>
