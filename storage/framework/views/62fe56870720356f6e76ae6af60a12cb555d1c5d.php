    ...
    <div class="site-menubar-body">
      <div>
        <div>
          ...
          <br/>
 <!-------------- Dashboard menu --------------->			
	 <li class="site-menu-category" style="margin-top:1px; text-transform:none;font-size:16px; color:white; "><b></b></li>
...
<!-------------- roles and permission  menu --------------->
	...
	<!-------------- Message  menu --------------->
		<?php if (\Entrust::can('exchangerate.search')) : ?>
			 <li class="site-menu-item has-sub <?php echo e(Request::is('exchangerate') ? 'active open' : ''); ?>">
              <a href="javascript:void(0)">
			  <i class="site-menu-icon fa fa-book-o" aria-hidden="true"></i>
                <span class="site-menu-title"><?php echo e(trans('app.exchangerate')); ?></span>
                <span class="site-menu-arrow"></span>
              </a>
              <ul class="site-menu-sub">
                <li class="site-menu-item <?php echo e(Request::is('exchangerate') ? 'active' : ''); ?>">
                  <a class="animsition-link" href="<?php echo e(URL::to('/exchange_rate')); ?>">
                    <span class="site-menu-title"><?php echo e(trans('app.exchangerate')); ?></span>
                  </a>
                </li>
              </ul>
